...
def posterior(x, n, P, Pr):
    ...
    Args:
        ...
        If Pr is not a numpy.ndarray with the same
         shape as P, raise a TypeError with the message
        ...
        If Pr does not sum to 1, raise
         a ValueError with the message Pr must sum to 1
